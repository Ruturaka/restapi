...
@RestController
@RequestMapping("/api")
public class TutorialCotroller {
    //– TutorialController is a RestController which has request mapping
    // methods for RESTful requests such as: getAllTutorials,
    // createTutorial, updateTutorial, deleteTutorial, findByPublished…
    @Autowired
